...
public class Order {
    ...
    public final int orderId; // unique for each order
    public boolean buySell; // buy=true, sell=false
    public boolean marketLimit; // market= true, limit= false
    public boolean status; // executed/canceled= true, pending=false
    public int shares; // no of shares
    long price; // price per share
    long entryTime; // time when order was placed
    public long eventTime; // time when order was executed
