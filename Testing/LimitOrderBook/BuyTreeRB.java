...
public class BuyTreeRB {
    ...
    Rules of Red Black Tree
     ...
     3. No 2 cosecutive red nodes allowed, red child cannot have red parent and vice versa
     4. Number of black nodes from every node to all its descendent leaves should be same
    
    Notes:
    - A Red-Black Tree is less strict than an AVL tree in balancing height.
    - The height of the longest path can be at most twice that of the shortest path.
